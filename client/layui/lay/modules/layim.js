...
;layui.define(["layer", "laytpl", "upload"], function (i) {
    ...
    c.prototype.config = function (i) {
        ...
        lcf = e(".layim-chatlist-friend" + i.id);
        if (lcf.length < 1) {
            var t = e(".layim-list-friend .layim-friend" + i.id + " .layim-msg-status");
    ...
    var x, b, w, k, C, S = function (i, a, n) {
        ...
        var lms = e(".layim-list-friend .layim-friend" + i.id + " .layim-msg-status");
